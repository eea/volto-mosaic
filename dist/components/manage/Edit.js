...
var _reactDndHtml5Backend = _interopRequireDefault(
  ...
  (function(_Component) {
    ...
    function Edit(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(Edit).call(this, props),
      );
          ...
          if (
            ...
            this.props.history.push(
              this.props.returnUrl ||
                (0, _helpers.getBaseUrl)(this.props.pathname),
            );
          }
        },
        /**
      ...
      },
      {
        ...
        value: function render() {
          ...
          if (this.props.schemaRequest.loaded && this.props.content) {
            var visual =
              (0, _helpers.hasTilesData)(this.props.schema.properties) ||
              this.props.content['@type'] === 'Plone Site';
            var FormImpl =
              this.props.content.layout == 'mosaic_tiles_view'
                ? _Form['default']
                : _components.Form;
  ...
  (0, _reactRedux.connect)(
    function(state, props) {
      return {
        ...
        returnUrl: _queryString['default'].parse(props.location.search)
          .return_url,
      };
    },
    {
