...
var _videocamera = _interopRequireDefault(require("@plone/volto/icons/videocamera.svg"));
...
function (_Component) {
  ...
  function AddNewTile(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AddNewTile).call(this, props));
    var availableTiles = [{
      title: 'text',
      icon: _text["default"]
    }, {
  ...
  _createClass(AddNewTile, [{
    ...
    value: function render() {
      ...
      }, _react["default"].createElement(_semanticUiReact.Button.Group, null, this.state.availableTiles.map(function (tile) {
...
function (_Component2) {
  ...
  function Form(props) {
    ...
    _defineProperty(_assertThisInitialized(_this3), "onChange", function (currentNode) {
      // this.setState({  });
      var tilesLayoutFieldname = (0, _helpers.getTilesLayoutFieldname)(_this3.state.formData);

      _this3.setState({
        currentNode: currentNode,
        formData: _objectSpread({}, _this3.state.formData, _defineProperty({}, tilesLayoutFieldname, _objectSpread({}, _this3.state.formData[tilesLayoutFieldname], {
          layout: currentNode,
    ...
    _defineProperty(_assertThisInitialized(_this3), "onResize", function (event, _ref) {
    ...
    _defineProperty(_assertThisInitialized(_this3), "getToolbar", function (tileid, onMutateTile) {
      ...
      return function (props, draggable) {
        ...
        }, titlediv, _react["default"].createElement("div", {
          className: "mosaic-window-controls"
        }, _react["default"].createElement(_reactMosaicComponent.Separator, null), _react["default"].createElement(AddNewTile, {
          onMutateTile: onMutateTile,
          tile: tileid
        }), _react["default"].createElement(_reactMosaicComponent.Separator, null), _react["default"].createElement(_reactMosaicComponent.SplitButton, null), _react["default"].createElement(_reactMosaicComponent.ExpandButton, null), _react["default"].createElement(_reactMosaicComponent.RemoveButton, null)));
      };
    });
    ...
    var _tilesLayoutFieldname = (0, _helpers.getTilesLayoutFieldname)(_formData);

    var defaultLayoutHeight = _formData[_tilesLayoutFieldname].layout_height || 500;
    ...
    if (!_formData[_tilesFieldname]) {
      ...
      _formData[_tilesFieldname] = (_formData$_tilesField = {}, _defineProperty(_formData$_tilesField, ids.title, {
        '@type': 'title'
    ...
    _this3.state = {
      formData: _formData,
      errors: {},
      selected: _formData[_tilesLayoutFieldname].items.length > 0 ? _formData[_tilesLayoutFieldname].items[0] : null,
      currentNode: _currentNode,
      height: defaultLayoutHeight
    };
    _this3.onChangeField = _this3.onChangeField.bind(_assertThisInitialized(_this3));
    _this3.onChangeTile = _this3.onChangeTile.bind(_assertThisInitialized(_this3));
    _this3.onMutateTile = _this3.onMutateTile.bind(_assertThisInitialized(_this3));
    _this3.onSelectTile = _this3.onSelectTile.bind(_assertThisInitialized(_this3));
    _this3.onDeleteTile = _this3.onDeleteTile.bind(_assertThisInitialized(_this3));
  ...
  _createClass(Form, [{
    ...
    value: function onChangeField(id, value) {
      this.setState({
        formData: _objectSpread({}, this.state.formData, _defineProperty({}, id, value || null))
      });
    }
    /**
     * Change tile handler
    ...
    value: function onChangeTile(id, value) {
      var tilesFieldname = (0, _helpers.getTilesFieldname)(this.state.formData);
      this.setState({
        formData: _objectSpread({}, this.state.formData, _defineProperty({}, tilesFieldname, _objectSpread({}, this.state.formData[tilesFieldname], _defineProperty({}, id, value || null))))
      });
    }
    /**
     * Change tile handler
    ...
    value: function onMutateTile(id, value) {
      ...
      var tilesFieldname = (0, _helpers.getTilesFieldname)(this.state.formData);
      var tilesLayoutFieldname = (0, _helpers.getTilesLayoutFieldname)(this.state.formData);
      var index = this.state.formData[tilesLayoutFieldname].items.indexOf(id) + 1;
      this.setState({
        formData: _objectSpread({}, this.state.formData, (_objectSpread8 = {}, _defineProperty(_objectSpread8, tilesFieldname, _objectSpread({}, this.state.formData[tilesFieldname], (_objectSpread7 = {}, _defineProperty(_objectSpread7, id, value || null), _defineProperty(_objectSpread7, idTrailingTile, {
          '@type': 'text'
        }), _objectSpread7))), _defineProperty(_objectSpread8, tilesLayoutFieldname, {
          items: [].concat(_toConsumableArray(this.state.formData[tilesLayoutFieldname].items.slice(0, index)), [idTrailingTile], _toConsumableArray(this.state.formData[tilesLayoutFieldname].items.slice(index))),
    ...
    value: function onDeleteTile(id, selectPrev) {
      ...
      var tilesLayoutFieldname = (0, _helpers.getTilesLayoutFieldname)(this.state.formData);
      this.setState({
        formData: _objectSpread({}, this.state.formData, (_objectSpread9 = {}, _defineProperty(_objectSpread9, tilesLayoutFieldname, {
          items: (0, _lodash.without)(this.state.formData[tilesLayoutFieldname].items, id),
          layout: this.state.currentNode,
          layout_height: this.state.height
        }), _defineProperty(_objectSpread9, tilesFieldname, (0, _lodash.omit)(this.state.formData[tilesFieldname], [id])), _objectSpread9)),
        selected: selectPrev ? this.state.formData[tilesLayoutFieldname].items[this.state.formData[tilesLayoutFieldname].items.indexOf(id) - 1] : null
      });
    }
    /**
     * Add tile handler
    ...
    value: function onAddTile(type, index) {
      ...
      var tilesFieldname = (0, _helpers.getTilesFieldname)(this.state.formData);
      var tilesLayoutFieldname = (0, _helpers.getTilesLayoutFieldname)(this.state.formData);
      var totalItems = this.state.formData[tilesLayoutFieldname].items.length;
      var insert = index === -1 ? totalItems : index;
      var currentNode = this.state.currentNode;

      if (currentNode) {
        var path = (0, _reactMosaicComponent.getPathToCorner)(currentNode, _reactMosaicComponent.Corner.TOP_RIGHT);
        var parent = (0, _reactMosaicComponent.getNodeAtPath)(currentNode, (0, _dropRight["default"])(path));
        var destination = (0, _reactMosaicComponent.getNodeAtPath)(currentNode, path);
        var direction = parent ? (0, _reactMosaicComponent.getOtherDirection)(parent.direction) : 'row';
        var first;
        var second;
      ...
      this.setState({
        formData: _objectSpread({}, this.state.formData, (_objectSpread11 = {}, _defineProperty(_objectSpread11, tilesLayoutFieldname, {
          items: [].concat(_toConsumableArray(this.state.formData[tilesLayoutFieldname].items.slice(0, insert)), [id], _toConsumableArray(this.state.formData[tilesLayoutFieldname].items.slice(insert))),
          layout: currentNode,
          layout_height: this.state.height
        }), _defineProperty(_objectSpread11, tilesFieldname, _objectSpread({}, this.state.formData[tilesFieldname], _defineProperty({}, id, {
          '@type': type
        }))), _objectSpread11)),
        selected: id
      });
        ...
        return (0, _lodash.map)(fieldset.fields, function (fieldId) {
          ...
          if (_this5.props.schema.required.indexOf(fieldId) !== -1) {
            if (field.type !== 'boolean' && !data) {
              ...
              errors[fieldId].push(_this5.props.intl.formatMessage(messages.required));
            }

            if (field.minLength && data.length < field.minLength) {
              errors[fieldId] = errors[field] || [];
              errors[fieldId].push(_this5.props.intl.formatMessage(messages.minLength, {
                len: field.minLength
              }));
            }
          }

          if (field.uniqueItems && data && (0, _lodash.uniq)(data).length !== data.length) {
            errors[fieldId] = errors[field] || [];
            errors[fieldId].push(_this5.props.intl.formatMessage(messages.uniqueItems));
          }
        });
      });
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
      ...
      }, _react["default"].createElement(_reactResizable.ResizableBox, {
        width: 200,
        ...
        renderTile: function renderTile(tileid, path) {
          return _react["default"].createElement(_reactMosaicComponent.MosaicWindow // <number>
          , {
            title: "Window",
            ...
            renderToolbar: _this6.getToolbar(tileid, _this6.onMutateTile),
            key: tileid
          }, _this6.renderEditTile(tileid));
        },
        zeroStateView: _react["default"].createElement(_reactMosaicComponent.MosaicZeroState, {
        ...
        return [_react["default"].createElement(_react["default"].Fragment, {
          ...
          secondary: true,
          attached: true
        }, item.title), ",", _react["default"].createElement(_semanticUiReact.Segment, {
          attached: true
        }, (0, _lodash.map)(item.fields, function (field, index) {
          return _react["default"].createElement(_components.Field, _extends({}, schema.properties[field], {
            id: field,
            focus: index === 0,
...
_defineProperty(Form, "propTypes", {
  schema: _propTypes["default"].shape({
    fieldsets: _propTypes["default"].arrayOf(_propTypes["default"].shape({
