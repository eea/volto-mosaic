...
function (_Component) {
  ...
  function MosaicView(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MosaicView).call(this, props));
    ...
    _defineProperty(_assertThisInitialized(_this), "onChange", function (currentNode) {
      _this.setState({
        currentNode: currentNode
      });
    });

    _defineProperty(_assertThisInitialized(_this), "onRelease", function (currentNode) {
  ...
  _createClass(MosaicView, [{
    ...
    value: function renderTile(tileid) {
      ...
      return Tile !== null ? _react["default"].createElement("div", {
        "class": "tile-container"
      }, _react["default"].createElement(Tile, {
        key: tileid,
        properties: content,
        data: availableTiles[tileid]
      })) : _react["default"].createElement("div", null, " ", JSON.stringify(tiletype), " ");
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return true ? _react["default"].createElement("div", {
        id: "page-document",
        ...
        renderTile: function renderTile(tileid, path) {
          return _react["default"].createElement(_reactMosaicComponent2.MosaicWindow, {
      ...
      }, content.title), content.description && _react["default"].createElement("p", {
        className: "documentDescription"
      }, content.description), content.image && _react["default"].createElement(_semanticUiReact.Image, {
        className: "document-image",
        src: content.image.scales.thumb.download,
        floated: "right"
      }), content.remoteUrl && _react["default"].createElement("span", null, "The link address is:", _react["default"].createElement("a", {
        href: content.remoteUrl
      }, content.remoteUrl)), content.text && _react["default"].createElement("div", {
        dangerouslySetInnerHTML: {
          __html: content.text.data.replace(/a href="([^"]*\.[^"]*)"/g, "a href=\"".concat(_config.settings.apiPath, "$1/download/file\""))
        }
      }));
    }
  }]);
